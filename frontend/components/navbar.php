<nav class="bg-white w-full flex items-center justify-between px-3 py-2 sm:px-6 sm:py-4 shadow-sm h-20">
    ...
    <div class="flex items-center space-x-2 sm:space-x-4">
        ...
        <!-- Notification Button -->
        <button type="button" class="relative p-2 hover:bg-gray-200 rounded-full transition" aria-label="notifications" onclick="window.location.href='<?= $baseUrl ?>/notifications'">
