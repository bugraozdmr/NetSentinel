<nav class="bg-gradient-to-r from-slate-900 to-slate-800 shadow-2xl w-full flex flex-wrap items-center justify-between px-3 py-2 h-20 z-50 overflow-x-hidden">
    ...
    <div class="flex items-center gap-1 flex-shrink-0">
        ...
        <button type="button" class="relative p-2 bg-slate-800 hover:bg-blue-700 rounded-full transition min-w-0" aria-label="notifications" onclick="window.location.href='<?= $baseUrl ?>/notifications'">
            ...
            <span class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 text-[12px] bg-red-500 text-white rounded-full flex items-center justify-center ring-2 ring-white hidden"></span>
        </button>
    </div>
</nav>